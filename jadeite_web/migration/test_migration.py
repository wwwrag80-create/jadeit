...
from migrate_sqlite_to_supabase import read_legacy_db, normalize_date, build_report, chunked
...
INSERT INTO invoices VALUES
 ...
 (4,'2026-08-02 10:00:00','عميل','خياس طقوم',1.25,0,0,'خياس طقم','ACTIVE',0,'S-1','1','5001'),
...
assert t["txn_date"] == "2026-07-01T09:00:00"
print("✔ قراءة الحركات وتحويل التاريخ لصيغة ISO سليمة")

# التاريخ بدون وقت يُكمَّل تلقائياً
assert data["transactions"][4]["txn_date"] == "2026-08-03T00:00:00"
